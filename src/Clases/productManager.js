...
export default class ProductManager {
  ...
  async addProduct(input) {
    ...
    const check = Object.values(input).some((valor) => valor === undefined || valor === "" || valor === null);
  ...
  async updateProduct(id, edicion) {
    ...
    const check = Object.values(edicion).some((valor) => valor === undefined || valor === "" || valor === null)
